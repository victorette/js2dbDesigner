...
Ext.define('JS2DBDesigner.view.diagram.DiagramCanvas', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.canvas',

    requires: ['JS2DBDesigner.view.diagram.DiagramToolbar', 'Ext.toolbar.Toolbar'],
    ...
    reload: function() {
        ...
        var controller = JS2DBDesigner.app.getController('DiagramController');
    ...
    onContextMenu: function(figure, x, y) {
        ...
        if ( typeof figure.sourcePort === "undefined") {
            var tableContextMenu = Ext.create('JS2DBDesigner.view.diagram.TableContextMenu', {
                figure: figure
            });
