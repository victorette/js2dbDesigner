...
Ext.define('JS2DBDesigner.view.diagram.DiagramToolbar', {
            ...
            items: [
                {
                    ...
                    border: 1,
                    disabled: true,
                    text: DBDesigner.__language.Text_Undo_Button
                },
                {
                    xtype: 'button',
                    itemId: 'btRedo',
                    disabled: true,
                    text: DBDesigner.__language.Text_Redo_Button
                },
                {
                    xtype: 'tbspacer',
					width: 10
                },
                {
                    ...
                    itemId: 'btDelete',
					disabled: true,
                    text: DBDesigner.__language.Text_Delete_Button
                },
                {
                    xtype: 'tbspacer'
                },
                    ...
                    items: [
                        {
                            xtype: 'button',
                            itemId: 'btZoomIn',
                            text: DBDesigner.__language.Text_ZoomIn_Button
                        },
                        {
                            xtype: 'button',
                            itemId: 'btZoomNormal',
                        ...
                        },
						{
                            xtype: 'button',
                            itemId: 'btZoomOut',
                            text: DBDesigner.__language.Text_ZoomOut_Button
                        }
                    ]
                },
                {
                ...
                },
                {
                    ...
                    text: DBDesigner.__language.Text_Save_Diagram_Button
                },
                {
                	xtype: 'button',
                	iconCls: 'send-to-DB',
                    itemId: 'btSyncToDB',
                    disabled: true,
                    text: DBDesigner.__language.Text_Commit_Changes_Button
                },
                {
                	xtype: 'button',
                	iconCls: 'icon-print',
                	itemId: 'btExportDiagram',
                	text: DBDesigner.__language.Text_Export_Image
                }
            ]
        });
