Ext.define('JS2DBDesigner.view.diagram.EntityEditor', {
    extend: 'Ext.form.Panel',
    alias: 'widget.entityeditor',

    requires: ['JS2DBDesigner.view.diagram.EntityAttributes', 'Ext.form.FieldSet', 'Ext.form.field.Text', 'Ext.grid.Panel'],
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            items: [{
                ...
                sourceConfig: {
                    tableName: {
                        displayName: '<strong>' + DBDesigner.__language.Label_Table_Name + '</strong>'
                    },
                    isPrimary: {
                        displayName: DBDesigner.__language.Label_Dependency
                    },
                    name: {
                        displayName: '<strong>' + DBDesigner.__language.Label_Connector_Name + '</strong>'
                    },
                    color: {
                ...
                title: DBDesigner.__language.Title_Attributes,
                height: 280
            }]
        });
        ...
        this.dockedItems = [{
            ...
            items: [{
                iconCls: 'menu_reload',
                itemId: 'btSaveTable',
                text: DBDesigner.__language.Text_UpdateDiagram_Button,
                action: 'savetable'
            }]
        }];
